...
class DatePickerLocators:
    ...
    # === ЗАГОЛОВОК КАЛЕНДАРЯ ===
    MONTH_YEAR_HEADER = ".react-datepicker__current-month" # Заголовок текущего месяца/года
    ...
    # === НАВИГАЦИЯ ===
    PREV_MONTH_BUTTON = ".react-datepicker__navigation--previous"  # Кнопка предыдущего месяца
    NEXT_MONTH_BUTTON = ".react-datepicker__navigation--next"      # Кнопка следующего месяца
    ...
    DAY_OUTSIDE_MONTH = ".react-datepicker__day--outside-month" # День вне текущего месяца
    DAY_WEEKEND = ".react-datepicker__day--weekend"        # Выходной день
    DAY_KEYBOARD_SELECTED = ".react-datepicker__day--keyboard-selected" # Выбранный с клавиатуры
    ...
    TIME_LIST_ITEM_SELECTED = ".react-datepicker__time-list-item--selected" # Выбранное время
