...
class ToolTipsLocators:
    ...
    # === ТЕКСТ ДЛЯ ПРОВЕРКИ ===
    BUTTON_TOOLTIP_TEXT = "You hovered over the Button"   # Ожидаемый текст подсказки кнопки
    INPUT_TOOLTIP_TEXT = "You hovered over the text field" # Ожидаемый текст подсказки поля
    LINK_TOOLTIP_TEXT = "You hovered over the Contrary"   # Ожидаемый текст подсказки ссылки
    SECTION_TOOLTIP_TEXT = "You hovered over the 1.10.32" # Ожидаемый текст подсказки секции
