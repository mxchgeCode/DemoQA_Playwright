...
class DragabbleLocators:
    ...
    TAB_AXIS_RESTRICTED = "#draggableExample-tab-axisRestriction"  # Вкладка ограничения по осям
    TAB_CONTAINER_RESTRICTED = "#draggableExample-tab-containerRestriction"  # Вкладка ограничения контейнером
    ...
    DRAG_BOX_CONTAINER = "#containmentWrapper #dragBox" # Элемент в ограниченном контейнере
    DRAGGABLE_DIV_CONTAINER = ".draggable.ui-widget-content.ui-draggable.ui-draggable-handle"  # Div в контейнере
    DRAGGABLE_SPAN_CONTAINER = ".ui-widget-header.ui-draggable.ui-draggable-handle"  # Span в контейнере
    ...
    # === КОНТЕЙНЕРЫ ВКЛАДОК ===
    SIMPLE_TAB_PANE = "#draggableExample-tabpane-simple"  # Панель простого перетаскивания
    AXIS_TAB_PANE = "#draggableExample-tabpane-axisRestriction"  # Панель ограничения по осям
