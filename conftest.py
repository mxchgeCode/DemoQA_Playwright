...
#
#
# # В секции импортов исправить:
# from pages.alerts.alerts_page import AlertsPage
#
# # Исправленная фикстура alerts_page:
# @pytest.fixture(scope="function")  # Изменили scope на function для изоляции
# def alerts_page(page: Page):
#     """Фикстура для страницы Alerts с правильным URL."""
#     try:
#         # Используем правильный URL для alerts
